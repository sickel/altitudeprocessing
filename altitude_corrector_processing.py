...
from .altitude_corrector_processing_provider import altituteCorrectorProvider
...
class altituteCorrectorPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = altituteCorrectorProvider()
